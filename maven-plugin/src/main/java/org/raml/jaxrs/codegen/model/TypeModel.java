...
public class TypeModel extends GenericElementModel implements ITypeModel{
	 ...
	 */
	public TypeModel(TypeModelRegistry registry,Class<?> actualClass,String genericName) {
		this.registry = registry;
		this.qualifiedName = actualClass.getName();
		this.genericName = genericName;
		this.actualClass = actualClass;
		this.setName(actualClass.getSimpleName());
	...
	private List<ITypeModel> implementedInterfaces = new ArrayList<ITypeModel>();
	
	protected TypeModelRegistry registry;
	...
	public void addImplementedInterface(ITypeModel implementedInterface){
	...
	public boolean isCollection() {
		return this instanceof ICollectionTypeModel;
	}

	@Override
	public boolean isMap() {
		return this instanceof IMapTypeModel;
	}
